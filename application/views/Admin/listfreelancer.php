    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Data user freelance</h1>
                    </div>
                    <?php foreach ($freelancer as $key) : ?>
                        <tr>
                            <td>Nama Lengkap:<?= $user['nama'] ?></td>
                            <td>Nama Lengkap:<?= $key->agama ?></td>
                            <td>Nama Lengkap:<?= $key->kewarganegaraan ?></td>
                            <td>Nama Lengkap:<?= $key->jenis_kelamin ?></td>
                            <td>Nama Lengkap:<?= $key->agama ?></td>
